...
require(ROOT_PATH . 'includes/lib_axlm.php');
...
if ((!isset($_SESSION['admin_id']) || intval($_SESSION['admin_id']) <= 0) &&
    ...
    $_REQUEST['act'] != 'forget_pwd' && $_REQUEST['act'] != 'reset_pwd' && $_REQUEST['act'] != 'check_order' && $_REQUEST['act'] != 'dayfenhong' && $_REQUEST['act'] != 'ranrun' )
{
